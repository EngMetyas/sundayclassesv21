...
export default async function handler(req:any,res:any){
 ...
 try{
  ...
  const {full_name,email,password,role='member',sector_id=null,class_id=null,phone=null,birth_date=null,address=null}=req.body||{};
  ...
  try{
   await db('profiles',{method:'POST',headers:{Prefer:'return=minimal'},body:JSON.stringify({id:user.id,full_name,username:email,email,role,sector_id:finalSector,class_id:role==='member'?class_id:null,phone:phone||null,birth_date:birth_date||null,address:address||null,active:true})});
